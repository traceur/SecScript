#! /usr/bin/env python 
#! coding:utf-8 
#! change form :http://zone.wooyun.org/content/20976
...
if len(sys.argv) < 4: 
    ...
    print "\t    Usage: 163|tencent使用方法：python mail.py type <userlist> <wordlist>\n" 
    print "\t    Usage: 236|exchange|coremail使用方法：python mail.py type <userlist> <wordlist> mail.domain.com\n"   
